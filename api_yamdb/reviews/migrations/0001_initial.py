# Generated by Django 3.2 on 2023-04-19 12:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(validators=[api_yamdb.validators.validate_slug], verbose_name='Адрес')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='title',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='titles', to='reviews.title', verbose_name='Произведение'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
